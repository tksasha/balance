...
func InitializeServer() *server.Server {
	...
	routesRoutes := routes.New(createHandler, listHandler, handlersCreateHandler, deleteHandler, editHandler, handlersListHandler, newHandler, updateHandler, handlersDeleteHandler, handlersEditHandler, listHandler2, handlersUpdateHandler, handlerHandler, createHandler2, editHandler2, listHandler3, updateHandler2)
	v := middlewares.New()
