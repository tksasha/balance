...
func (m *MockRepository) Create(ctx context.Context, arg1 *category.Category) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(ctx context.Context, arg1 *category.Category) error {
	m.ctrl.T.Helper()
